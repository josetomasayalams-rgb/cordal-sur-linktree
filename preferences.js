...
(() => {
  ...
  const TRANSLATIONS = Object.freeze({
    es: Object.freeze({
      ...
      "page.description": "Arrau · Cordal Sur: alojamiento para hasta 7 huéspedes en Condominio Andes Chillán, Las Trancas. Explora sus 47 fotografías y consulta disponibilidad.",
      ...
      "page.heading": "Arrau, una propiedad Cordal Sur en Andes Chillán",
      "hero.photos": "Fotografías de Arrau",
      "portfolio.eyebrow": "Colección Cordal Sur",
      "property.selector.aria": "Propiedades Cordal Sur",
      "property.arrau.location": "Andes Chillán · Las Trancas",
      "property.arrau.story": "Inspirado en el Volcán Arrau, parte del complejo Nevados de Chillán.",
      ...
      "gallery.open": "Explorar {count} fotos",
      "gallery.preview.open": "Abrir la galería desde {description}",
      ...
      "availability.dateSelected": "Noche seleccionada",
      ...
      "availability.chooseDeparture": "Elige fecha de salida",
      ...
      "availability.revealPrices": "Revelar precios",
      "availability.revealPrices.detail": "Muestra el valor de la noche seleccionada o el total de tu estadía.",
      "availability.pricesRevealed": "Precios visibles para las fechas seleccionadas.",
      ...
      "availability.nightlyPrice": "Precio por noche",
      ...
      "gallery.kicker": "Colección fotográfica",
      "gallery.title": "Arrau",
      "gallery.description": "Recorre cada ambiente de la propiedad.",
      "gallery.all": "Todas",
      "gallery.filters.aria": "Filtrar fotografías por ambiente",
      "gallery.stage.aria": "Visor de fotografías",
      "gallery.thumbnails.aria": "Miniaturas de la galería",
      "gallery.previous": "Fotografía anterior",
      "gallery.next": "Fotografía siguiente",
      ...
      "gallery.habitacion1": "Habitación 1", "gallery.habitacion1.caption": "Vista de la habitación",
      "gallery.habitacion2": "Habitación 2", "gallery.habitacion2.caption": "Vista de la habitación",
      "gallery.habitacion3": "Habitación 3", "gallery.habitacion3.caption": "Vista de la habitación",
      "gallery.bano1": "Baño completo 1", "gallery.bano1.caption": "Vista del baño",
      "gallery.bano2": "Baño completo 2", "gallery.bano2.caption": "Vista del baño",
      "gallery.balcon": "Balcón", "gallery.balcon.caption": "Balcón y vista",
      "gallery.exterior": "Exterior", "gallery.exterior.caption": "Vista exterior",
      "gallery.entrada": "Entrada y guardabotas", "gallery.entrada.caption": "Entrada con guardabotas",
      "gallery.close": "Cerrar galería",
      "gallery.viewer.close": "Cerrar foto ampliada",
      "gallery.photo.alt": "Arrau · {category}: {caption}",
    ...
    pt: Object.freeze({
      "page.title": "Arrau · Cordal Sur | Andes Chillán",
      "page.description": "Arrau · Cordal Sur: hospedagem para até 7 hóspedes no Condomínio Andes Chillán, em Las Trancas. Explore suas 47 fotografias e consulte a disponibilidade.",
      ...
      "page.heading": "Arrau, uma propriedade Cordal Sur em Andes Chillán",
      "hero.photos": "Fotografias de Arrau",
      "portfolio.eyebrow": "Coleção Cordal Sur",
      "property.selector.aria": "Propriedades Cordal Sur",
      "property.arrau.location": "Andes Chillán · Las Trancas",
      "property.arrau.story": "Inspirado no Vulcão Arrau, parte do complexo Nevados de Chillán.",
      ...
      "gallery.open": "Explorar {count} fotos",
      "gallery.preview.open": "Abrir a galeria a partir de {description}",
      "hero.eyebrow": "Andes Chillán · Las Trancas",
      ...
      "availability.dateSelected": "Noite selecionada",
      ...
      "availability.chooseDeparture": "Escolha a data de saída",
      ...
      "availability.revealPrices": "Revelar preços",
      "availability.revealPrices.detail": "Mostra o valor da noite selecionada ou o total da sua estadia.",
      "availability.pricesRevealed": "Preços visíveis para as datas selecionadas.",
      ...
      "availability.estimate": "Subtotal estimado",
      "availability.nightlyPrice": "Preço por noite",
      ...
      "gallery.kicker": "Coleção fotográfica", "gallery.title": "Arrau", "gallery.description": "Explore cada ambiente da propriedade.",
      "gallery.all": "Todas",
      "gallery.filters.aria": "Filtrar fotografias por ambiente",
      "gallery.stage.aria": "Visualizador de fotografias",
      "gallery.thumbnails.aria": "Miniaturas da galeria",
      "gallery.previous": "Fotografia anterior",
      "gallery.next": "Próxima fotografia",
      "gallery.counter": "{current} / {total}",
      "gallery.thumbnail.aria": "Foto {current} de {total}: {description}",
      ...
      "gallery.habitacion1": "Quarto 1", "gallery.habitacion1.caption": "Vista do quarto",
      "gallery.habitacion2": "Quarto 2", "gallery.habitacion2.caption": "Vista do quarto",
      "gallery.habitacion3": "Quarto 3", "gallery.habitacion3.caption": "Vista do quarto",
      "gallery.bano1": "Banheiro completo 1", "gallery.bano1.caption": "Vista do banheiro",
      "gallery.bano2": "Banheiro completo 2", "gallery.bano2.caption": "Vista do banheiro",
      "gallery.balcon": "Varanda", "gallery.balcon.caption": "Varanda e vista",
      "gallery.exterior": "Exterior", "gallery.exterior.caption": "Vista externa",
      "gallery.entrada": "Entrada e armário para botas", "gallery.entrada.caption": "Entrada com armário para botas",
      "gallery.close": "Fechar galeria", "gallery.viewer.close": "Fechar foto ampliada",
      "gallery.photo.alt": "Arrau · {category}: {caption}", "gallery.expand": "Ampliar {description}",
    ...
    en: Object.freeze({
      "page.title": "Arrau · Cordal Sur | Andes Chillán",
      "page.description": "Arrau · Cordal Sur: accommodation for up to 7 guests at Andes Chillán Condominium in Las Trancas. Explore its 47 photographs and check availability.",
      ...
      "page.heading": "Arrau, a Cordal Sur property in Andes Chillán",
      "hero.photos": "Photographs of Arrau",
      "portfolio.eyebrow": "Cordal Sur Collection",
      "property.selector.aria": "Cordal Sur properties",
      "property.arrau.location": "Andes Chillán · Las Trancas",
      "property.arrau.story": "Inspired by Volcán Arrau, part of the Nevados de Chillán volcanic complex.",
      ...
      "gallery.open": "Explore {count} photos",
      "gallery.preview.open": "Open the gallery from {description}",
      "hero.eyebrow": "Andes Chillán · Las Trancas",
      ...
      "availability.dateSelected": "Selected night",
      ...
      "availability.chooseDeparture": "Choose checkout date",
      ...
      "availability.revealPrices": "Reveal prices",
      "availability.revealPrices.detail": "Shows the selected nightly rate or the total for your stay.",
      "availability.pricesRevealed": "Prices are visible for the selected dates.",
      ...
      "availability.nightlyPrice": "Price per night",
      ...
      "gallery.kicker": "Photo collection", "gallery.title": "Arrau", "gallery.description": "Explore every space in the property.",
      "gallery.all": "All",
      "gallery.filters.aria": "Filter photographs by area",
      "gallery.stage.aria": "Photo viewer",
      "gallery.thumbnails.aria": "Gallery thumbnails",
      ...
      "gallery.habitacion1": "Bedroom 1", "gallery.habitacion1.caption": "Bedroom view",
      "gallery.habitacion2": "Bedroom 2", "gallery.habitacion2.caption": "Bedroom view",
      "gallery.habitacion3": "Bedroom 3", "gallery.habitacion3.caption": "Bedroom view",
      "gallery.bano1": "Full bathroom 1", "gallery.bano1.caption": "Bathroom view",
      "gallery.bano2": "Full bathroom 2", "gallery.bano2.caption": "Bathroom view",
      "gallery.balcon": "Balcony", "gallery.balcon.caption": "Balcony and view",
      "gallery.exterior": "Exterior", "gallery.exterior.caption": "Exterior view",
      "gallery.entrada": "Entry and boot storage", "gallery.entrada.caption": "Entry with boot storage",
      "gallery.close": "Close gallery", "gallery.viewer.close": "Close enlarged photo",
      "gallery.photo.alt": "Arrau · {category}: {caption}", "gallery.expand": "Enlarge {description}",
