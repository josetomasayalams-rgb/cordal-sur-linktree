...
(() => {
  ...
  const TRANSLATIONS = Object.freeze({
    es: Object.freeze({
      ...
      "gallery.preview.next": "Mostrar otra selección de fotos",
      ...
      "availability.description": "Selecciona un mínimo de 2 noches y conoce el valor estimado de tu estadía.",
      "availability.minimumStay": "Estadía mínima: 2 noches",
      ...
      "availability.checkoutOnly": "Disponible únicamente como fecha de salida",
      "availability.selected": "Seleccionado",
      "availability.today": "Hoy",
      "availability.past": "Fecha pasada",
      "availability.outsideRange": "Fuera del período disponible",
      "availability.dateSelected": "Llegada seleccionada",
      ...
      "availability.selectionInvalidated": "La disponibilidad cambió y limpiamos tus fechas. Selecciona una nueva llegada.",
      "availability.selectArrival": "Selecciona tu fecha de llegada.",
      "availability.selectDeparture": "Ahora selecciona tu fecha de salida (mínimo 2 noches).",
      ...
      "availability.minimumStay.short": "2+ noches",
      "availability.minimumStay.checkout": "No disponible como salida; la estadía mínima es de 2 noches.",
      "availability.minimumStay.error": "La estadía mínima es de 2 noches. Elige una fecha de salida posterior.",
      "availability.minimumStay.arrival": "Desde esa fecha no hay 2 noches consecutivas disponibles. Elige otra llegada.",
      "availability.minimumStay.arrivalUnavailable": "No disponible como llegada; no hay 2 noches consecutivas libres desde esta fecha.",
      ...
      "availability.revealPrices.detail": "Muestra el desglose y el total estimado de tu estadía.",
      ...
      "gallery.zoom.controls": "Controles de ampliación",
      "gallery.zoom.out": "Alejar fotografía",
      "gallery.zoom.reset": "Restablecer ampliación",
      "gallery.zoom.in": "Ampliar fotografía",
    ...
    pt: Object.freeze({
      ...
      "gallery.preview.next": "Mostrar outra seleção de fotos",
      "hero.eyebrow": "Andes Chillán · Las Trancas",
      ...
      "availability.description": "Selecione no mínimo 2 noites e consulte o valor estimado da sua estadia.",
      "availability.minimumStay": "Estadia mínima: 2 noites",
      ...
      "availability.checkoutOnly": "Disponível apenas como data de saída",
      "availability.selected": "Selecionado",
      "availability.today": "Hoje",
      "availability.past": "Data passada",
      "availability.outsideRange": "Fora do período disponível",
      "availability.dateSelected": "Chegada selecionada",
      ...
      "availability.selectionInvalidated": "A disponibilidade mudou e limpamos suas datas. Selecione uma nova chegada.",
      "availability.selectArrival": "Selecione a data de chegada.",
      "availability.selectDeparture": "Agora selecione a data de saída (mínimo de 2 noites).",
      ...
      "availability.minimumStay.short": "2+ noites",
      "availability.minimumStay.checkout": "Não disponível como saída; a estadia mínima é de 2 noites.",
      "availability.minimumStay.error": "A estadia mínima é de 2 noites. Escolha uma data de saída posterior.",
      "availability.minimumStay.arrival": "Não há 2 noites consecutivas disponíveis a partir dessa data. Escolha outra chegada.",
      "availability.minimumStay.arrivalUnavailable": "Não disponível como chegada; não há 2 noites consecutivas livres a partir desta data.",
      ...
      "availability.revealPrices.detail": "Mostra o detalhamento e o total estimado da sua estadia.",
      ...
      "gallery.zoom.controls": "Controles de ampliação",
      "gallery.zoom.out": "Reduzir fotografia",
      "gallery.zoom.reset": "Redefinir ampliação",
      "gallery.zoom.in": "Ampliar fotografia",
      "gallery.counter": "{current} / {total}",
      "gallery.thumbnail.aria": "Foto {current} de {total}: {description}",
    ...
    en: Object.freeze({
      ...
      "gallery.preview.next": "Show another photo selection",
      "hero.eyebrow": "Andes Chillán · Las Trancas",
      ...
      "availability.description": "Select a minimum of 2 nights and see the estimated price for your stay.",
      "availability.minimumStay": "Minimum stay: 2 nights",
      ...
      "availability.checkoutOnly": "Available only as a checkout date",
      "availability.selected": "Selected",
      "availability.today": "Today",
      "availability.past": "Past date",
      "availability.outsideRange": "Outside the available period",
      "availability.dateSelected": "Arrival selected",
      ...
      "availability.selectionInvalidated": "Availability changed, so we cleared your dates. Select a new arrival.",
      "availability.selectArrival": "Select your arrival date.",
      "availability.selectDeparture": "Now select your checkout date (minimum 2 nights).",
      ...
      "availability.minimumStay.short": "2+ nights",
      "availability.minimumStay.checkout": "Not available as checkout; the minimum stay is 2 nights.",
      "availability.minimumStay.error": "The minimum stay is 2 nights. Choose a later checkout date.",
      "availability.minimumStay.arrival": "There are not 2 consecutive nights available from this date. Choose another arrival.",
      "availability.minimumStay.arrivalUnavailable": "Not available as an arrival; there are not 2 consecutive free nights from this date.",
      ...
      "availability.revealPrices.detail": "Shows the breakdown and estimated total for your stay.",
      ...
      "gallery.zoom.controls": "Zoom controls",
      "gallery.zoom.out": "Zoom out photograph",
      "gallery.zoom.reset": "Reset zoom",
      "gallery.zoom.in": "Zoom in photograph",
      "gallery.counter": "{current} / {total}",
