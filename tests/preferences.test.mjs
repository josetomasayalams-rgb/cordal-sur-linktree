...
test("applies the saved Linktree theme before styles load", () => {
  ...
  const preferencesScript = html.indexOf('<script src="preferences.js?v=minimum-two-night-stay-20260721" defer>');
  const appScript = html.indexOf('<script src="app.js?v=minimum-two-night-stay-20260721" defer>');
